...
students1 = [
    ...
    Student("Bob", "B002", 8.7),
    Student("Charlie", "C003", 9.2)
]
students2 = [
    Student("David", "D004", 7.8),
    Student("Eve", "E005", 8.9),
    Student("Frank", "F006", 8.3)
]
students3 = [
    Student("Grace", "G007", 9.7),
    Student("Harry", "H008", 9.4),
    Student("Ivy", "I009", 9.6)
]
